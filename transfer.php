...
<head>
	...
	body{
		...
		background-image:url("images/efg.jpg");
		 ...
		 function random_function()
            {
				...
				if(a==="junaid"){
				 var arr=["kalyan","mahek","mahmood","pavan","shadab","sohail","SYED","ubed","wasay"];
				 }
				 else if(a==="kalyan"){
					var arr=["junaid","mahek","mahmood","pavan","shadab","sohail","SYED","ubed","wasay"];
				}
				else if(a==="mahek"){
					var arr=["junaid","kalyan","mahmood","pavan","shadab","sohail","SYED","ubed","wasay"];
				}
				else if(a==="mahmood"){
					var arr=["junaid","kalyan","mahek","pavan","shadab","sohail","SYED","ubed","wasay"];
				 }
				 else if(a==="pavan"){
					var arr=["junaid","kalyan","mahek","mahmood","shadab","sohail","SYED","ubed","wasay"];
				 }
				 else if(a==="shadab"){
					var arr=["junaid","kalyan","mahek","mahmood","pavan","sohail","SYED","ubed","wasay"];
				 }
				 else if(a==="sohail"){
					var arr=["junaid","kalyan","mahek","mahmood","pavan","shadab","SYED","ubed","wasay"];
				 }
				 else if(a==="SYED"){
					var arr=["junaid","kalyan","mahek","mahmood","pavan","shadab","sohail","ubed","wasay"];
				 }
				 else if(a==="ubed"){
					var arr=["junaid","kalyan","mahek","mahmood","pavan","shadab","sohail","SYED","wasay"];
				 }
				 else if(a==="wasay"){
				 var arr=["junaid","kalyan","mahek","mahmood","pavan","shadab","sohail","SYED","ubed"];
				 }
                var string="";
...
<body>
	...
	<form action="updatecredit.php" method="post">
		...
		<select id="input" name="sender"style="font-size: 12pt; height: 28px; width:290px;" align="middle" onchange="random_function()">
			...
			<option value="mahek">mahek</option>
			...
			<option value="wasay">wasay</option>
		</select><br><br>
